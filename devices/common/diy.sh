...
sed -i '$a src-git mzwrt_package https://github.com/mzwrt/mzwrt_package.git;main' feeds.conf.default
...
./scripts/feeds install -a -p mzwrt_package -f
./scripts/feeds install -a

rm -rf package/base-files feeds/luci/modules/luci-base
mv -f feeds/mzwrt_package/base-files package/
mv -f feeds/mzwrt_package/luci-base package/feeds/luci/
...
mv -f feeds/mzwrt_package/r81* tmp/
...
sed -i \
	...
	package/feeds/mzwrt_package/*/Makefile
